// Copyright 2015 atsurabzaid M.R.
// YECAN 01 FrVts3PewEdhJUAwDR2ot5Rny2N2
...
#define FIREBASE_HOST "holamundo-2e35f.firebaseio.com"
#define FIREBASE_AUTH "aL99GrQ0f8zhziEQpREmBsyuogLS8Dol95txJpbV"

//#define WIFI_SSID "INLACKECHHALAKEN"
//#define WIFI_PASSWORD "A0n3G1e1Lv"
...
//const char *ssidConf = "Ω Y-KAN de atsurabzaid φ";
//const char *passConf = "12345678";

const char *ssidConf = "atsurabzaid Ω Y-KAN 01"; // este es el nombre de la red wifi de Ω Y-KAN
const char *passConf = "";

String mensaje = "bienvenido a atsurabzaid technology  Ω Y-KAN 01   "
                  
                  "atsurabzaid visita nuestras redes sociales o ponte en contacto   "
                  "atsurabzaid@gmail.com ---correo electronico  "
                  "AZ Tech --------Facebook    "
                  "@atsurabzaid----Twitter     "
                  "@atsurabzaid11---Instagram   "
                  
                  "El modo de configuracion de  Ω Y-KAN guarde aqui su conexion ";
